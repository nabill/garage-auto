...
<div class="row mb-4">
    <div class="col-12">
        <img src="/assets/img/services/mecanique-generale.jpg" alt="Mécanique générale" class="w-100 rounded-3 shadow-sm" style="height:400px;object-fit:cover;object-position:center;">
    </div>
</div>
